...
while True:
    ...
    shaft_position = (0.07, -0.2)
    door_positions = [(0.208, 0.83, 0.), (0.04, 0.73, 0.38)]
    x_range = [-0.5, 0.5]
    y_range = [-0.5, 1.5]
    z_range = [-1, 0.5]
    angle_degree = 20
    ...
    idx_z = np.where((0.35 < z_coords) & (z_coords < 0.4))[0]
    x_coords_z = x_coords[idx_z]
    y_coords_z = y_coords[idx_z]
